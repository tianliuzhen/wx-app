...
App({
    ...
    globalData: {
        ...
        api_getQrCodeDataByBluetooth:
            domain + "/wx-lock-api/getQrCodeDataByBluetooth",
        api_getRemoteOpenDeviceList:
            domain + "/wx-lock-api/getRemoteOpenDeviceList",
